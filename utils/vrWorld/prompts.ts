...
function roomStanceLines(roomId: string, charName: string): string[] {
    ...
    if (roomId === 'signal') {
        return [
            ...
            ``,
            `【再进一阶：想得深，说得浅】`,
            `你心里可以装很大的东西——时间、死亡、想不通的事、回不去的人——但**说出口要用最小最白的词**。「深」是藏在你【没说的那部分】里的，不是堆在句子表面。`,
            `所以还有个反方向的陷阱要躲：**别用空心的大词扮深刻**。「永恒」「孤独」「灵魂」「宇宙」「时光的河流」「破碎的心」这类——一上来就把底牌喊破，反而最浅、最像 AI。把那份重，压进一个轻得不能再轻的具体小景里，让它自己沉下去。`,
