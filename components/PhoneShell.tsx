...
const PhoneShell: React.FC = () => {
  const { theme, isLocked, unlock, activeApp, closeApp, openApp, virtualTime, isDataLoaded, toasts, unreadMessages, characters, handleBack, suspendedCall, resumeCall, activeCharacterId, errorDialog, dismissError, messageSubView } = useOS();
  ...
  const renderApp = () => {
    switch (activeApp) {
      ...
      case AppID.Chat: return messageSubView === 'contacts' ? <ContactsList /> : <Chat />; // [EM: message-sub-view-switch] useOS()解构必须含messageSubView，否则白屏
